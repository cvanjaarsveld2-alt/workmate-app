...
export const MODULES = [
  ...
  { key: "quotes_invoicing", label: "Quotes, jobs & invoices", hint: "Quotes, job cards, invoices, payments", screens: ["Quotes", "Jobs", "Invoices"] },
  ...
  { key: "jack_selector", label: "Jack selector", hint: "Mining machine jacking guide", screens: ["JackSelector"] },
