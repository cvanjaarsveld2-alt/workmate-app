...
const REMOTE_EXCLUDED_FIELDS={quotes:new Set(["contact_id","from_user_id","to_user_id","job_id","invoice_id","quote_id","linked_breakdown_id","linked_note_id","linked_client_id","sync_pending_quote_id","sync_pending_job_id","sync_pending_client_id","sync_pending_note_id","sync_pending_team_id","sync_pending_invoice_id"]),followups:new Set(["invoice_id","job_id"]),expenses:new Set(["assigned_to_user_id","contact_id","from_user_id","to_user_id","linked_note_id","linked_breakdown_id","quote_id","job_id","invoice_id","sync_pending_quote_id","sync_pending_job_id","sync_pending_client_id","sync_pending_note_id","sync_pending_team_id","sync_pending_invoice_id"])};
