...
// violation. Usage: npm run test:sim
...
const SCREENS = "Home,Clients,Contacts,Followups,Notes,Equipment,Quotes,Expenses,More,Planner,ColdCall,JackSelector,Meeting,Breakdown,Repair,Diagnostics,BackfillZAR,Analytics,Leads,Team,VehicleCheck,Notifications,SharedInbox,Jobs,Invoices,Client360,Calendar,TeamDashboard";
const ACCOUNTS = [
