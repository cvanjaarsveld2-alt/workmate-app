...
const SCREENS = "Home,Clients,Contacts,Followups,Notes,Equipment,Quotes,Expenses,More,Planner,ColdCall,JackSelector,Meeting,Breakdown,Repair,Diagnostics,BackfillZAR,Analytics,Leads,Team,VehicleCheck,Notifications,SharedInbox,Jobs,Invoices,CompanyProfile,Help,Platform,AuditLog,Client360,Calendar,TeamDashboard";
const ACCOUNTS = [
